...
namespace Cassandra.Data.Linq
{
    internal static class CqlQueryTools
    {
        ...
        public static string Encode(this object obj)
        {
            ...
            else if (obj.GetType().GetTypeInfo().IsGenericType)
            {
                if (obj.GetType().GetInterfaces().FirstOrDefault(x=>x.Name=="ISet`1") != null)
                {
                ...
                else if (obj.GetType().GetInterfaces().Where(x=>x.Name=="IDictionary`2").FirstOrDefault() != null)
                {
                    var sb = new StringBuilder();
                ...
                else if (obj.GetType().GetInterfaces().Where(x=>x.Name=="IEnumerable`1").FirstOrDefault() != null)
                {
                    var sb = new StringBuilder();
                    foreach (object el in (IEnumerable) obj)
                    {
