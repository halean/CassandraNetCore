...
namespace Cassandra
{
    ...
    public class Host
    {
        ...
        public bool IsUp
        {
            get { return Volatile.Read(ref _isUpNow) == 1; }
        }
        ...
        {
            get { return Volatile.Read(ref _isUpNow) == 1 || _nextUpTime <= DateTimeOffset.Now.Ticks; }
        }
        ...
        internal bool SetDown(bool failedReconnection)
        {
            ...
            Volatile.Write(ref _nextUpTime, DateTimeOffset.Now.Ticks + (delay * TimeSpan.TicksPerMillisecond));
