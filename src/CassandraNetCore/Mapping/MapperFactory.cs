...
namespace Cassandra.Mapping
{
    ...
    internal class MapperFactory
    {
        ...
        private Expression GetExpressionToGetValueFromPoco(ParameterExpression poco, PocoColumn column)
        {
            ...
            return Expression.Call(converter.Target == null ? null : Expression.Constant(converter.Target), converter.GetMethodInfo(), getValueFromPoco);
        }
        ...
        private Expression GetExpressionToGetColumnValueFromRow(ParameterExpression row, CqlColumn dbColumn, Type pocoDestType)
        {
            ...
            else
            {
                ...
                convertedValue = Expression.Call(converter.Target == null ? null : Expression.Constant(converter.Target), converter.GetMethodInfo(), getValueT);
            }
        ...
        private static bool TryGetCreateEmptyCollectionExpression(CqlColumn dbColumn, Type pocoDestType, out Expression createEmptyCollection)
        {
            ...
            if (pocoDestType.GetTypeInfo().IsInterface == false)
            {
            ...
            else
            {
                ...
                if (pocoDestType.IsConstructedGenericType == false)
                    return false;
        ...
        {
            return t.GetInterfaces().FirstOrDefault(i => i.IsConstructedGenericType && i.GetGenericTypeDefinition() == typeof (ICollection<>)) != null;
        }
    }
}
