        ...
        private Task<bool> ConnectSsl()
        {
            ...
            }).Then(_ =>
            {
                ...
                try
                {
                    ...
                    */
                    sslStream.AuthenticateAsClientAsync(targetHost, SSLOptions.CertificateCollection, SSLOptions.SslProtocol,
                        SSLOptions.CheckCertificateRevocation);
                    tcs.TrySetResult(true);
        ...
        protected virtual void ReceiveAsync()
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    int bytesRead=_socketStream.ReadAsync(_receiveBuffer, 0, _receiveBuffer.Length).Result;
        ...
        public void Write(RecyclableMemoryStream stream, Action onBufferFlush)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    _socketStream.WriteAsync(stream.GetBuffer(), 0, length).RunSynchronously();
                    OnWriteFlushed();
                    if (WriteCompleted != null)
                    {
                        WriteCompleted();
